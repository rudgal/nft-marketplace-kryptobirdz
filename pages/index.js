...
export default function Home() {
  ...
  return (
    <div className="flex justify-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:gird-cols-4 gap-4 pt-4" style={{ maxWidth: '160px' }}>
        {nfts.map((nft, i) => (
          <div key={i} className="border shadow rounded-x1 overflow-hidden">
            ...
            <div className="p-4 bg-black">
              ...
              <button
                className="w-full bg-purple-500 text-white font-boid py-3 px-12 rounded"
                onClick={() => buyNFT(nft)}
              ></button>
            </div>
          </div>
